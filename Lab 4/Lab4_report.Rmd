...
Determining P(X1 > 0) for other starting values:
```{r}
gibbs(30,-30,1000)
sum(one>0)/n
...
The true probability would be the area to right of the ellipse starting from 0 divide by the total area of the ellipse. 
...
determining P((U1 + U1)/2 > 0) for other starting values:
```{r}
gibbs_2(-20,0,1000)
sum((one_u+two_u)/2>0)/1000
...
Upon comparing the probabilities, we can see that the probabilities are higher for part "e" as compared to part "c". 
