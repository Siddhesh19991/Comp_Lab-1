...
g_gradient <- function(x){c(-2*x[1] - 2*x[2]^2*x[1] - 2*x[2]+2, -2*x[1]^2*x[2] -2*x[1])}
g_Hessian <- function(x){matrix(c(-2-2*x[2]^2, -4*x[1]*x[2], -4*x[1]*x[2]-2, -2*x[1]^2), nrow=2)} # by col by default
```
