...
```
Based on the output from the "glm" function, we can say that the output compared to b) and c) are almost the same with some changes in the last few decimal place. 
